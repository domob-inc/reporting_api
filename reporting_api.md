...
You can use this method to obtain specific country statistics. You can find the regoin code map with ISO_3166-3(https://en.wikipedia.org/wiki/ISO_3166-3), and you can search the region code in https://countrycode.org/
